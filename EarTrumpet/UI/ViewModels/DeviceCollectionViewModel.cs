...
namespace EarTrumpet.UI.ViewModels
{
    public class DeviceCollectionViewModel : BindableBase
    {
        ...
        public static SndVolSSO.IconId GetSndVolIconFromDeviceIcon(DeviceIconKind deviceIconKind)
        {
            switch (deviceIconKind)
            {
                ...
                default: throw new NotImplementedException(deviceIconKind.ToString());
            }
        }
    }
}