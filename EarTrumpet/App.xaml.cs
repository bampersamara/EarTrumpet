...
namespace EarTrumpet
{
    public partial class App
    {
        ...
        {
            var iconType = (PlaybackDevicesViewModel.Default == null) ? SndVolSSO.IconId.NoDevice : DeviceCollectionViewModel.GetSndVolIconFromDeviceIcon(PlaybackDevicesViewModel.Default.IconKind);
